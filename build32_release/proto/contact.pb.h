...
#ifndef PROTOBUF_proto_2fcontact_2eproto__INCLUDED
#define PROTOBUF_proto_2fcontact_2eproto__INCLUDED
...
class Person_PhoneNumber : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Person.PhoneNumber) */ {
 ...
 private:
  ...
  int type_;
  friend void  protobuf_AddDesc_proto_2fcontact_2eproto();
  friend void protobuf_AssignDesc_proto_2fcontact_2eproto();
  friend void protobuf_ShutdownFile_proto_2fcontact_2eproto();
...
#endif  // PROTOBUF_proto_2fcontact_2eproto__INCLUDED
