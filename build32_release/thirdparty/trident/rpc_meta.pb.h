...
#ifndef PROTOBUF_thirdparty_2ftrident_2frpc_5fmeta_2eproto__INCLUDED
#define PROTOBUF_thirdparty_2ftrident_2frpc_5fmeta_2eproto__INCLUDED
...
class RpcMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:trident.RpcMeta) */ {
 public:
  RpcMeta();
  virtual ~RpcMeta();
  ...
  ::trident::RpcMeta_Type type() const;
  void set_type(::trident::RpcMeta_Type value);
  ...
  ::trident::CompressType compress_type() const;
  void set_compress_type(::trident::CompressType value);
  ...
  ::trident::CompressType expected_response_compress_type() const;
  void set_expected_response_compress_type(::trident::CompressType value);

  // @@protoc_insertion_point(class_scope:trident.RpcMeta)
 private:
  ...
  friend void  protobuf_AddDesc_thirdparty_2ftrident_2frpc_5fmeta_2eproto();
  friend void protobuf_AssignDesc_thirdparty_2ftrident_2frpc_5fmeta_2eproto();
  friend void protobuf_ShutdownFile_thirdparty_2ftrident_2frpc_5fmeta_2eproto();
...
template <> struct is_proto_enum< ::trident::RpcMeta_Type> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_thirdparty_2ftrident_2frpc_5fmeta_2eproto__INCLUDED
